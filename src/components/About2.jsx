      ...
      <div className="grid grid-cols-8 gap-6 place-items-center">
        ...
        <div className="flex flex-row p-6">
          ...
          <div className="flex flex-col mt-4 px-3">
            ...
            <p className="text-lg text-white/70 mt-2">Currently pursuing a degree in B.Tech. Computer Science. I excel at FrontEnd Development and DevOps along with knowledge about ML and NLP.</p>
          </div>
        </div>
        ...
        <div className="flex flex-row p-6">
          ...
          <div className="flex flex-col mt-4 px-0">
            ...
            <p className="text-lg text-white/70 mt-2">I approch challenges with a logical and cool mindset </p>
          </div>
        </div>
        ...
        <div className="flex flex-row p-6">
          ...
          <div className="flex flex-col mt-4 px-3">
            ...
            <p className="text-lg text-white/70 mt-2">I am proficient in Reactjs, Nextjs, Firebase, AWS, Docker, NLP and ML Concepts.       
            </p>
          </div>
        </div>
